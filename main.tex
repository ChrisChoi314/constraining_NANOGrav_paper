...
\label{fig:contours}
\end{figure}
\hspace{-1em}allowed value by the BBN bound, as described by Eq.\ \ref{eqn:tau_m_bbn} in order to reproduce the NG15 signal.
...
%When ready send me pdf - I am loggin out 

%so potentially 2 weeks past te 7th is okay, if it is difficult for you right now since I know you are going through personal emergency. I will do my berst. It is not like personal, but I have several dead;ines, I am in mcwilliams fellowship search committee and co-chair for grad admission. hundreds of applications needs to bee read

%CC: Ok I see. I have also cropped whitespace from fig 3 to make the figure larger and easier to read 
%will do the same for fig 4. ok it looks good now. yes I am ready. i will just read through to make sure no typos
