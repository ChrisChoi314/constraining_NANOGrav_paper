...
\usepackage{graphicx,bm,color,amsmath,amssymb, mathtools,subcaption,float,dblfloatfix}
\graphicspath{{./fig/}}
...
% discuss a bit more the figure, and put (top) M, ... etc 
...
% maybe have 3 sigma or 1 sigma instead of 4 sigma 
\onecolumngrid
\begin{center}
\begin{figure}
...
% in discussion make sure to use full words not acronyms 
...
%what are the limiations of our paper, how do you plan on generalizing this to future work
