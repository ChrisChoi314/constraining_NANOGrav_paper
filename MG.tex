...
In this paper, we consider the primordial GW hypothesis, with an amplification due to MG. We consider MG due to its promising ability to explain the present exponential expansion. 
...
\begin{equation}\label{eqn:mass_case}
   ...
   \end{cases} \ ,
\end{equation} 
where $\tau_m$ is the conformal time when the graviton mass instantaneously drops to 0. This is the simplest scheme for time-dependence of the graviton mass, and despite its non-physical nature, it will suffice for our purposes to demonstrate the relevant aspects of the theory.  
